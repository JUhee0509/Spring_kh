		...
		<form name="f" method="post">
		 <table border="1" width="700" align="center">
		 	...
		 	<tr>
		 		<td colspan="2">
		 			<!-- 목록으로 -->
		 			<img src="/bbs/resources/img/btn_list.gif" onclick="location.href='list.do?page=${param.page}&search=${ param.search }&search_text=${ param.search_text }'" style="cursor: pointer;">
